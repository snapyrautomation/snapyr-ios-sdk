...
@implementation SnapyrAES256Crypto
...
{
    NSData *iv = [SnapyrAES256Crypto randomDataOfLength:kAlgorithmIVSize];
    NSData *salt = [SnapyrAES256Crypto randomDataOfLength:kPBKDFSaltSize];
